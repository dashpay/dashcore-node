...
describe("Dash Service", function () {
  ...
  describe("#_spawnChildProcess", function () {
    ...
    it("will include network with spawn command and init zmq/rpc on node", function (done) {
      ...
      dashd._spawnChildProcess(function (err, node) {
        ...
        spawn.args[0][1].should.deep.equal(["--conf=testdir/dash.conf", "--datadir=testdir", "--testnet"]);
  ...
  describe("#isSynced", function () {
    ...
    it('will give "true" if percentage is 100.00', function (done) {
      var dashd = new DashService(baseConfig);
      dashd.syncPercentage = sinon.stub().callsArgWith(0, null, 100.0);
  ...
  describe("#_getAddressStrings", function () {
    ...
    it("will get address strings from strings", function () {
      var addresses = ["XjxDQFjTNEP9dcrJhBLvy5i1Dobz4x1LJN", "7d5169eBcGHF4BYC6DTffTyeCpWbrZnNgz"];
      var dashd = new DashService(baseConfig);
      var strings = dashd._getAddressStrings(addresses);
      strings[0].should.equal("XjxDQFjTNEP9dcrJhBLvy5i1Dobz4x1LJN");
      strings[1].should.equal("7d5169eBcGHF4BYC6DTffTyeCpWbrZnNgz");
    ...
    it("will get address strings from mixture of types", function () {
      var addresses = [dashcore.Address("XjxDQFjTNEP9dcrJhBLvy5i1Dobz4x1LJN"), "7d5169eBcGHF4BYC6DTffTyeCpWbrZnNgz"];
      var dashd = new DashService(baseConfig);
      var strings = dashd._getAddressStrings(addresses);
      strings[0].should.equal("XjxDQFjTNEP9dcrJhBLvy5i1Dobz4x1LJN");
      strings[1].should.equal("7d5169eBcGHF4BYC6DTffTyeCpWbrZnNgz");
    ...
    it("will give error with unknown", function () {
      var addresses = [dashcore.Address("XjxDQFjTNEP9dcrJhBLvy5i1Dobz4x1LJN"), 0];
      var dashd = new DashService(baseConfig);
      (function () {
  ...
  describe("#getBlockHeaders", function () {
    ...
    it("will get an array of block headers", function () {
      ...
      dashd.getBlockHeaders(
        _blockHash,
        function (err, blockHeader) {
          should.not.exist(err);
        ...
        result: [
          {
            ...
            DataHex:
              "",
            DataObject: {
          ...
          },
          {
            ...
            DataHex:
              "",
            DataObject: {
          ...
          },
          {
            ...
            DataHex:
              "",
            DataObject: {
      ...
      var gobject = sinon.stub().callsArgWith(2, null, {
        result: {
          DataHex:
            "",
          DataString:
            '[["proposal",{"end_epoch":1483855193,"name":"7ea9acff5ae83d8c9e217d30a2b4d10ef8f171f8","payment_address":"yZ7DYkDHCHfH1dw7rKdYaKcVykZmunbqNL","payment_amount":84,"start_epoch":1483765282,"type":1,"url":"https://www.dash.org"}]]',
          Hash: "4ef24027c631c43035aa4cf5c672e1298311decd9cffbd16731f454c9c0d6d00",
  ...
  describe("#getMNList", function () {
    it("will call client masternode list and give result", function (done) {
      var dashd = new DashService(baseConfig);
      dashd.isSynced = function (callback) {
          ...
          masternodelist: function (type, cb) {
            switch (type) {
              ...
              case "payee":
                return cb(null, {
                  result: {
                    "06c4c53b64019a021e8597c19e40807038cab4cd422ca9241db82aa19887354b-0":
                      "Xfpp5BxPfFistPPjTe6FucYmtDVmT1GDG3",
                    "b76bafae974b80204e79858eb62aedec41159519c90d23f811cca1eca40f2e4c-1":
                      "Xn16rfdygfViHe2u36jkDUs9NLmUrUsEKa",
                  },
                });
              case "lastseen":
                return cb(null, {
