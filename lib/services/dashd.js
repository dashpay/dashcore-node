...
Dash.prototype.getAddressUnspentOutputsPaginated = function(addressArg, options, callback) {
  ...
  function updateWithMempool(confirmedUtxos, mempoolDeltas) {
    ...
    if (!mempoolDeltas || !mempoolDeltas.length) {
      return self._paginate(confirmedUtxos, fromArg, toArg);
    }
    ...
    var utxos = self._paginate(mempoolUnspentOutputs.reverse().concat(confirmedUtxos), fromArg, toArg);
...
Dash.prototype._paginate = function(fullArray, fromArg, toArg) {
  var slicedArray;
